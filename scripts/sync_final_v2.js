...
try {
    ...
    db.transaction(() => {
        ...
        const insRoom = db.prepare('INSERT INTO ExamRoom (id, name, capacity, building) VALUES (?, ?, ?, ?)');
        ...
        const insMod = db.prepare('INSERT INTO Module (id, name, code, credits, formationId, semester) VALUES (?, ?, ?, ?, ?, ?)');
        ...
        // 6. Students
        const students = readCsv('students.csv'); // This is the 13000 file
        ...
        // 7. Sessions
        const sessions = readCsv('exam_sessions.csv'); // This is the 1500 file
        ...
        db.prepare('INSERT INTO UniversityInfo (id, name, totalStudents, totalDepartments, totalFormations) VALUES (1, "Univ Demo", 13000, 12, 45)').run();
    ...
    console.log('✅ Sync Successfully Finished. All users available.');
} catch (err) {
